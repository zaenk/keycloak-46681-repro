#!/usr/bin/env bash
# Repro script for https://github.com/keycloak/keycloak/issues/46681
#
...
run_repro() {
  local run_dir
  run_dir=$(mktemp -d "$GATLING_RESULTS_DIR/repro-46681-XXXXXX")
...
echo ""
echo "============================================================"
echo "  Repro: KC Issue #46681 — enabled=false under brute force"
echo "  Image: $KC_IMAGE"
echo "============================================================"
